  ...
  return (
    <Card className="mb-6">
      <CardContent className="p-6">
        <h3 className="text-lg font-semibold mb-4 text-gray-800">Choose Your Meditation Guide Voice</h3>
        <RadioGroup
          value={selectedVoice}
        ...
        >
          {voices.map((voice) => (
            <div key={voice.id} className="flex items-start space-x-3 p-3 rounded-lg border border-gray-200 hover:border-indigo-300 transition-colors">
